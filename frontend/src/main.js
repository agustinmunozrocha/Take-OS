...
import './lib/modelo.js'; // C5: modelo contactos + fábrica de proyectos
import './lib/data.js'; // catálogos y presets en window (LOC_*, REGIONES, BANCOS, DEFAULT_*, DTE_*, UNIDAD) — DEMO_PROJECTS eliminado en D0
import './lib/auth.js';
...
import './lib/boot.js'; // C6/D1: última entrada del manifiesto; su EVAL real se adelanta por imports (hoy ~29 vía perfil-onboarding) — su top-level solo requiere state + DOM estático (auditado)
