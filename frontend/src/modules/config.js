...
function closeConfigPanel() { closeModal(); }
...
function abrirFlujoCrearProductora(planId) {
...
window._cpVal = _cpVal;
window._cpWireDatos = _cpWireDatos;
...
window._empDatosConClave = _empDatosConClave;
...
window._empNombreMiembro = _empNombreMiembro;
window._empPerfilesOrg = _empPerfilesOrg;
...
window._pdConsentCargar = _pdConsentCargar;
window._pdConsentShell = _pdConsentShell;
...
window._pdCookiesHTML = _pdCookiesHTML;
window._pdEdadConfirmar = _pdEdadConfirmar;
window._pdEdadHTML = _pdEdadHTML;
window._pdElimCancelar = _pdElimCancelar;
window._pdElimCargar = _pdElimCargar;
window._pdElimConfirmar = _pdElimConfirmar;
window._pdElimEval = _pdElimEval;
window._pdElimProgramadaHTML = _pdElimProgramadaHTML;
window._pdElimShell = _pdElimShell;
window._pdExportHTML = _pdExportHTML;
window._pdExportReset = _pdExportReset;
window._pdExportSolicitar = _pdExportSolicitar;
window._pdFecha = _pdFecha;
window._pdHubHTML = _pdHubHTML;
window._pdIr = _pdIr;
window._pdRender = _pdRender;
window._pdRevocadoHTML = _pdRevocadoHTML;
