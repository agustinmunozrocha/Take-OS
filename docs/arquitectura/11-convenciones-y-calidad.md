...
- **`docs/Planes/`** (6 archivos, 1.185 líneas): planes de la modularización (`Plan_Modularizacion_Vite.md`, `Plan_Modularizacion_Juan_v7.md`, `PENDIENTES_Migracion_Vite.md` — deuda documentada: 404 de producción, cutover pendiente —, `HANDOFF_Code_PlanG_cablear_backend.md`, `RESUMEN_Sesion_Modularizacion.md`).
