...
Cobertura: 50/50 ✅ (0 bugs). MÓDULO CERRADO.

> **QA cerrado 2026-07-19 (Chrome MCP, localhost:5174 / etapa4-integracion):**
> las **47 pruebas 🤖** (todo lo verificable por modelo `STATE` / DOM / consola:
> motor de tiempo, unidades/planes, filas, columnas, banco+imágenes, cabecera,
> lógica de export y persistencia) se ejecutaron y **pasaron — 0 bugs, consola
> limpia** (ningún `[pr] fn sin mapear`). Las **3 pruebas 👁** de PDF (PR-46/47/48:
> orientación, contenido/colores, nombre de archivo) las aprobó **Agustín a ojo**
> el 2026-07-19. **Plan de Rodaje: 50/50 ✅, sin bugs de la migración.**
>
...
> con ≥1 día de rodaje activo. Las ⭐ son las sensibles; las 👁 necesitan tu vista.
