...
| LOC-16 | Borrar / Lightbox / Descargar todo | × en foto; click para lightbox (←/→/Esc); ⬇ Descargar todo | Borra de la nube; el lightbox navega; descarga todas con nombre base_NN.jpg | ⬜ |
